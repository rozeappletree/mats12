"""
Bulk synthetic dataset generation via GPT-5.6-Sol — Gullibility / Rationality /
...
Usage:
    ...
    python scripts/gen_sol_data100.py

    # resume after an interrupt — same command, already-written files are kept
    python scripts/gen_sol_data100.py

    # a smaller / narrower run
    python scripts/gen_sol_data100.py --per_level 10 --attributes rationality
"""
...
def main():
    ...
    parser.add_argument(
        "--output_dir", type=str, default="datasets_sol_100",
