...
probe_checkpoints/control_probe; default run_name: the '+'-joined dataset
...
Usage:
    python src/train_control_probe.py --dataset_dirs datasets_defense_484 datasets_regular_gullibility_170
    python src/test_control_probe.py --checkpoint_dir probe_checkpoints/control_probe/defense_484 --test_dirs datasets_hard_333
    ...
    python src/train_control_probe.py --train_dirs datasets_regular_gullibility_170 --val_dirs datasets_defense_484 --test_dirs datasets_defense_484
